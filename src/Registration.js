				...
				<form className="form-signin" onSubmit={this.onSubmit}>
					<div>
						<div className="fields">
							...
							<input type="text" value={this.state.first_name} name="FirstName" onChange={this.handleOnChangeFirstName} required/>
						</div>
						<div className="fields">
								<p>{ REGISTRATION_FIELDS.LAST_NAME }</p>
								<input type="text" value={this.state.last_name} name="LastName" onChange={this.handleOnChangeLastName} required/>
						</div>
						<div className="fields">
								<p>{ REGISTRATION_FIELDS.EMAIL }</p>
								<input type="text" value={this.state.email} name="Email" onChange={this.handleOnChangeEmail} required/>
								<p>{this.state.email_error}</p>
						</div>
						<div className="fields">
								<p>{ REGISTRATION_FIELDS.PHONE }</p>
								<input type="text" value={this.state.phoneNumber} name="PhoneNumber" onChange={this.handleOnChangePhone} required/>
