...
export default class Careers extends React.Component {
   ...
   onSubmit = async (e) => {
        ...
        if(this.refs.firstNameRef.innerHTML==""
            &&this.refs.emailIdRef.innerHTML==""
            &&this.refs.phoneNumberRef.innerHTML==""
            &&this.refs.zipCodeRef.innerHTML==""
            &&this.refs.commentsRef.innerHTML==""){
                const { firstName,emailId,phoneNumber,zipCode,comments } = this.state.userInfo
    ...
    render() {
        return(
            ...
            <div id="container">
                ...
                <br/>
	                <p>To apply for a position at neuZ, email your résumé and a few words about yourself to 
                         <a href="mailto:neuznews@gmail.com"> neuznews@gmail.com</a>.
	                    You can also apply directly here by filling out the form below.</p>
...
{/* 
                 ...
                 <input 
                        ...
                        <span id="errorName">{ this.displayValidationErrors('firstName') }</span>
                    <br/><br/>
                 ...
                 <input 
                        ...
                        <span id="errorEmail"> {this.displayValidationErrors('emailId')}  </span>
                 <br/><br/>
                 ...
                 <input 
                    ...
                    <span id="errorNumber">  {this.displayValidationErrors('phoneNumber')} </span>
                    <br/><br/>
                 ...
                 <input 
                    ...
                    <span id="errorZip"> {this.displayValidationErrors('zipCode')} </span>
                 <br/><br/>
                 ...
                 <textarea 
                        ...
                        <span id="commentsError"> { this.displayValidationErrors('comments') } </span>
