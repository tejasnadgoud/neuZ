        ...
        <div class="w3-container" id="about2">
          <div class="w3-content">
            ...
            <h5>
              <p>
                <b>
                  Discover and get inspired by the stories that shape your world
                </b>
              </p>
            </h5>
            <div class="w3-panel w3-leftbar w3-light-grey">
              <p>
                <i>"A part of your everyday life"</i>
              </p>
            </div>
          </div>
          <br />
          <img className="card-img-top1" src={neu} alt="Card image"></img>
          <p>
            <strong>Write to us:</strong> neuznews@gmail.com
          </p>
          <p>
            <strong>Address:</strong> 360 Huntington Ave, Boston, MA 02115
          </p>
        </div>
          ...
          <div className="col-sm-3">
            <div className="card1">
              <div className="card-body">
                ...
                <a href="mailto:tejasnadgoud@gmail.com">
                  {" "}
                  tejasnadgoud@gmail.com
                </a>
              </div>
            </div>
          </div>
          <div className="col-sm-3">
            <div className="card1">
              <div className="card-body">
                ...
                {/* <a href="#" className="btn btn-primary">More Info..</a> */}
                <a href="mailto:vaibhavdhoke@gmail.com">
                  {" "}
                  vaibhavdhoke@gmail.com
                </a>
              </div>
            </div>
          </div>
          <div className="col-sm-3">
            <div className="card1">
              <div className="card-body">
                ...
                <a href="mailto:rashmi24195@gmail.com">
                  {" "}
                  rashmi24195@gmail.com
                </a>
          ...
          <div className="col-sm-3">
            <div className="card1">
              <div className="card-body">
                ...
                {/* <a href="#" className="btn btn-primary">More Info..</a> */}
                <a href="mailto:pratyusha23kar@gmail.com">
                  {" "}
                  pratyusha23kar@gmail.com
                </a>
              </div>
            </div>
          </div>
