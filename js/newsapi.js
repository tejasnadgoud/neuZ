$(document).ready(function() {
    ...
    $("#searchNews").on("click", function(e) {
        console.log("Entered onclick search function");
        e.preventDefault();

        let query = $("#searchquery").val();
        console.log("Query is for: " + query);
        let url = "https://newsapi.org/v2/top-headlines?q=" + query + "&country=us&category=business&apiKey=563eb9a668de45bfa112693ad2932db0";
